...
{
    [RoutePrefix("api/ExecutiveSummary")]
    public class LegacyExecutiveSummaryGetDataController : ApiController
    {
        //mgougeon
        ...
        */
        ...
        [HttpGet]
        [Route("ConfirmRegistration/{FirstName}/{LastName}/{EmpNumber}/{BirthDate}/{Email}/{ImportID}")]
        public string ConfirmRegistration(string FirstName, string LastName, string EmpNumber, string BirthDate, string Email, int ImportID)
        {
