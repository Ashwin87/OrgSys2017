<%@ Page Title="" Language="C#" MasterPageFile="~/Orgsys_Forms/Master/Internal.Master" AutoEventWireup="true" CodeBehind="Transitional_RTW.aspx.cs" Inherits="Orgsys_2017.Orgsys_Forms.Internal_Forms.Transitional_RTW" %>
    ...
    $(document).ready(function () {
        ...
        function SaveForm() {
            ...
            $.ajax({
                ...
                url: getApi+"/api/TRWP/SaveTRWP",
                data: '=' + JSON.stringify({ trwpData: cols }),
                dataType: "JSON",
                success: function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link href="/Assets/css/TRWP.css" rel="stylesheet" />
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="col-lg">
            ...
            <div class="row">
                ...
                <b><u>Please report to your supervisor immediately if you have any difficulty completing assinged job tasks.</u></b> 
            </div>
            ...
            <div class="panel-body" style="border: 1px solid black; margin-top: 150px;">                
                <div class="row">
                    <div class="radio">
                ...
                <div class="row">                     
                    <p><b>Supervisor Signature: ___________________________&emsp;Date: <input type="text" name="SupCurrDate"/></b></p>                    
                </div>
            </div>
            <div class="row">
                <p><b><i>Note: this form must be completed by the employee and supervisor</b>&emsp;&emsp;CC: Supervisor, Employee, HR, Organizational Solutions Inc.</i></p>
            </div>
